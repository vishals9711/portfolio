...
const Skills = () => {
    ...
    return (
        <Box w="100%" display='flex' flexDirection='column' backgroundColor={backgroundColor} py='4'>
            <Box>
                <Heading as='h3' size='xl' marginBottom='16px' m='auto' color={divColor}>Skills</Heading>
            </Box>
            <Flex justifyContent='space-around' flexWrap='wrap' maxW='800px' m='auto'>
                {SKILLS.map(skill => <Badge fontSize="0.8em" m='4'> {skill}</Badge>)}
            </Flex>
        </Box>
    )
}
