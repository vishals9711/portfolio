import { i as identity, $ as $$Layout, r as renderScript, b as $$SignalDivider } from './Layout_B4_2olkS.mjs';
...
import { g as getEntry, r as renderEntry } from './_astro_content_BGzNrX55.mjs';
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "seo": {
    ...
    day: "numeric",
    year: "numeric"
  })} </span> <span>${remarkPluginFrontmatter.minutesRead}</span> </div> </div> <div class="article-image"> <img${addAttribute(entry.data.image.url, "src")}${addAttribute(entry.data.image.alt, "alt")}> </div> <div class="article-prose prose"> ${renderComponent($$result2, "Content", Content, {})} </div> </article> ` })} ${renderScript($$result, "/Users/vishal/Projects/products/portfolio/src/pages/blog/[id].astro?astro&type=script&index=0&lang.ts")}`;
